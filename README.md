# Test
NotePad++에 Plug-In을 Korean Charset Check하는 것을 만들어 올리고,
Git을 처음 작성해 보고 있다.
...
설치방법
---------------------------------------
1. [nppKoreanCharsetCheck.dll](https://github.com/zhangsob/nppKoreanCharsetCheck/bin/nppKoreanCharsetCheck.dll)을 다운받는다.
2. nppKoreanCharsetCheck.dll화일을 C:\Program Files (x86)\Notepad++\plugins에 넣는다.
   (만일, x64이면 [nppKoreanCharsetCheck.dll](https://github.com/zhangsob/nppKoreanCharsetCheck/bin64/nppKoreanCharsetCheck.dll)을 다운받는다.)